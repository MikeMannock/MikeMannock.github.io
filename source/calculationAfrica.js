function calculationAfrica() {
    ...
    for (let i = 0; i <= monthsCount; i++) {
        ...
        const createResult = document.createElement('td')
        ...
        if (!isLastMonth) {
            ...
            salaryTotal = salary * endDate.date()
        ...
        createResult.textContent = `${monthName} ${currentYear}: ${salaryTotal.toFixed(2)}`
        createRow.appendChild(createResult)
        // outputDiv.appendChild(createRow)
